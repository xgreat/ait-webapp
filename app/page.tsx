        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-400 mb-8 max-w-2xl mx-auto">
              ...
              Kirim pesan melalui form di bawah ini atau hubungi langsung.
            </p>
          </div>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-slate-400 text-sm">Chat langsung dengan tim kami</div>
                    </div>
                  </a>

                  <a
                    href="mailto:ait@plai.ac.id"
                    className="flex items-center gap-4 p-4 bg-slate-800 border border-slate-700 rounded-lg hover:bg-slate-700 transition-colors group"
                  >
                    <div className="w-12 h-12 bg-slate-600 rounded-full flex items-center justify-center group-hover:bg-slate-500 transition-colors">
                    ...
                    <div>
                      ...
                      <div className="text-slate-400 text-sm">ait@plai.ac.id</div>
                    </div>
                  </a>
                </div>
              </div>
              ...
              <div className="p-4 bg-sky-900/20 border border-sky-500/30 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-sky-400 mb-1">Keamanan Data</h4>
                    <p className="text-slate-400 text-sm">
                      Semua komunikasi dienkripsi dan data Anda dilindungi dengan standar keamanan tinggi.
                      Kami tidak pernah membagikan informasi Anda kepada pihak ketiga.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="flex flex-col items-center md:items-end">
              <h4 className="font-semibold text-white mb-2">Alamat Office</h4>
              <p className="text-slate-400 text-sm text-center md:text-right leading-relaxed">
                Jl. Raya Tajem No.KM. 3, Kenayan, Wedomartani,<br />
                Kec. Ngemplak, Kabupaten Sleman,<br />
